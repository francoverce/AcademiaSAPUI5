		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsofttekaca20241q-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsofttekaca20241q-display": {
								"semanticObject": "comsofttekaca20241q",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.softtek.aca20241q",
									"url": sap.ui.require.toUrl("com/softtek/aca20241q")
								}
							}
						}
					}
